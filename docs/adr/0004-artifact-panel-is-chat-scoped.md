...
inspectable outputs such as Vault pages or workspace files. The panel can also
open chat-scoped source browsers for Vault and the agent workspace without
