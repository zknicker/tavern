---
summary: Feature docs index for Tavern product capabilities: chat, agents, context management, memory, knowledgebase, automations, skills and plugins, stats, and pets.
read_when:
