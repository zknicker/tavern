...
The artifact pane should feel like a compact assistant workspace attached to the chat, not a full browser. It opens when the user clicks a linked output such as a Vault page, Markdown file, HTML preview, image, or generated asset.
...
- Should workspace files and Vault pages share one link scheme, or stay visibly distinct?

## Sample Agent Reply

I wrote the output here:

- [Panel Brief](tavern://vault/Demos/Panel%20Brief.md)
