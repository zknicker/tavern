...
function buildContextPayload(params) {
    return {
        ...
        ConversationLabel: params.conversation.label ?? undefined,
        From: params.from,
        GroupChannel: params.extra?.GroupChannel,
        GroupSubject: params.extra?.GroupSubject,
        GroupSystemPrompt: params.extra?.GroupSystemPrompt,
