...
export const agentRuntimeRoutes = {
    ...
    integration: (id: string) => `/integrations/${encodeURIComponent(id)}`,
    integrationMerchbaseAction: '/integrations/merchbase/action',
    integrationMerchbaseSalesSeries: '/integrations/merchbase/sales/series',
    integrationMerchbaseSettings: '/integrations/merchbase/settings',
