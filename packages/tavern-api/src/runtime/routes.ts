...
export const agentRuntimeRoutes = {
    ...
    chats: '/agent/chats',
    semanticMemoryBacklinks: (pagePath: string) =>
        `/memory/pages/${encodeURIComponent(pagePath)}/backlinks`,
    semanticMemoryFolder: (folderPath: string) =>
        `/memory/folders/${encodeURIComponent(folderPath)}`,
    semanticMemoryFolders: '/memory/folders',
    semanticMemoryMovePath: '/memory/move',
    semanticMemoryPage: (pagePath: string) => `/memory/pages/${encodeURIComponent(pagePath)}`,
    semanticMemoryPages: '/memory/pages',
    semanticMemorySearch: '/memory/search',
    semanticMemorySettings: '/memory/root-settings',
    semanticMemoryStatus: '/memory/status',
    health: '/health',
