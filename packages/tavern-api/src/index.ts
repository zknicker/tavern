...
export type TavernChatActivity = TavernApiSchema<'ChatActivity'>;
...
export type TavernListChatActivityResponse = TavernApiSchema<'ListChatActivityResponse'>;
...
export type TavernUpdateActivityRequest = TavernApiSchema<'UpdateActivityRequest'>;
