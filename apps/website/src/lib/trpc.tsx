...
export type WikiBacklinksOutput = RouterOutput['wiki']['backlinks'];
export type WikiListOutput = RouterOutput['wiki']['list'];
export type WikiPageOutput = RouterOutput['wiki']['get'];
export type WikiSettingsOutput = RouterOutput['wiki']['settings'];
export type WikiStatusOutput = RouterOutput['wiki']['status'];
...
export type BrowserSettingsOutput = RouterOutput['plugin']['browserSettings'];
