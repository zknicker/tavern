...
export type McpServerListOutput = RouterOutput['mcp']['list'];
export type McpServerSaveInput = RouterInput['mcp']['add'];
export type SemanticMemoryBacklinksOutput = RouterOutput['semanticMemory']['backlinks'];
export type SemanticMemoryListOutput = RouterOutput['semanticMemory']['list'];
export type SemanticMemoryPageOutput = RouterOutput['semanticMemory']['get'];
export type SemanticMemorySettingsOutput = RouterOutput['semanticMemory']['settings'];
export type SemanticMemoryStatusOutput = RouterOutput['semanticMemory']['status'];
...
export type McpCatalogOutput = RouterOutput['mcp']['catalog'];
