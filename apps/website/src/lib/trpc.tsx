...
export type VaultBacklinksOutput = RouterOutput['vault']['backlinks'];
export type VaultListOutput = RouterOutput['vault']['list'];
export type VaultPageOutput = RouterOutput['vault']['get'];
export type VaultSettingsOutput = RouterOutput['vault']['settings'];
export type VaultStatusOutput = RouterOutput['vault']['status'];
...
export type HermesConfigOutput = RouterOutput['hermesConfig']['get'];
export type MerchbaseSettingsOutput = RouterOutput['integration']['merchbaseSettings'];
export type MerchbaseSalesSeriesOutput = RouterOutput['integration']['merchbaseSalesSeries'];
...
export type McpCatalogOutput = RouterOutput['skill']['mcpCatalog'];
export type McpServerListOutput = RouterOutput['skill']['mcpServers'];
