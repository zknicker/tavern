...
export type CortexHealthOutput = RouterOutput['cortex']['health'];
...
export type SkillHubCatalogOutput = RouterOutput['skill']['hubCatalog'];
export type SkillHubItemOutput = SkillHubCatalogOutput['featured'][number];
export type SkillHubPreviewOutput = RouterOutput['skill']['hubPreview'];
export type SkillHubScanOutput = RouterOutput['skill']['hubScan'];
export type SkillHubSearchOutput = RouterOutput['skill']['hubSearch'];
