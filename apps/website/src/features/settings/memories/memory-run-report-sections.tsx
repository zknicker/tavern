...
export function MemoryRunReportContent({ job }: { job: MemoryRunReportView }) {
...
function ExtractionReport({ metadata }: { metadata: MemoryRunReportView['metadata'] }) {
...
function DreamReport({ metadata }: { metadata: MemoryRunReportView['metadata'] }) {
...
function SkillReviewReport({ metadata }: { metadata: MemoryRunReportView['metadata'] }) {
    const signals = readSignals(metadata);
...
function CurationReport({ metadata }: { metadata: MemoryRunReportView['metadata'] }) {
...
function FileChanges({ job }: { job: MemoryRunReportView }) {
