...
import { useSemanticMemoryBacklinks } from '../../../hooks/semantic-memory/use-semantic-memory-backlinks.ts';
import { cn } from '../../../lib/utils.ts';
import type { SemanticMemoryPageDetail } from './types.ts';
import { formatTimestamp } from './utils.ts';

export function SemanticMemoryDocumentInspector({
    onSelectPage,
    page,
}: {
...
function PageSignals({ page }: { page: SemanticMemoryPageDetail }) {
...
function BacklinksPanel({
    ...
    const backlinksQuery = useSemanticMemoryBacklinks({ path: page.path });
