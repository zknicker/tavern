...
import { SemanticMemoryDocumentInspector } from './semantic-memory-document-inspector.tsx';
import { SemanticMemoryDocumentPreview } from './semantic-memory-document-preview.tsx';
import { SemanticMemoryMarkdownEditor } from './semantic-memory-markdown-editor.tsx';
import type { SemanticMemoryLinkNavigate } from './semantic-memory-markdown-viewer.tsx';
import type { SemanticMemoryEditorMode } from './semantic-memory-topbar.tsx';
import type { SemanticMemoryPageDetail } from './types.ts';

export function SemanticMemoryDocumentPane({
    draft,
    editorMode,
    externalChangeState,
    inspectorOpen,
    ...
    draft: string;
    editorMode: SemanticMemoryEditorMode;
    ...
    page: SemanticMemoryPageDetail | null;
                ...
                >
                    {inspectorOpen ? (
                        <div className="h-full w-[320px]">
                            <SemanticMemoryDocumentInspector
