...
export function SemanticMemoryEditorToolbar() {
    ...
    return (
        <div className="semantic-memory-mdx-toolbar-shell">
            <div className="semantic-memory-mdx-toolbar-groups">
                <ToolbarGroup>
...
function ToolbarGroup({ children }: { children: React.ReactNode }) {
    return <div className="semantic-memory-mdx-toolbar-group">{children}</div>;
}
