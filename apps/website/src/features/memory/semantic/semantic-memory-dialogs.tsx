...
export type SemanticMemoryPathDialogMode = 'folder' | 'page';

export interface SemanticMemoryPathDialogState {
    mode: SemanticMemoryPathDialogMode;
    parentPath?: string;
    title: string;
}

export function SemanticMemoryPathDialog({
    errorMessage,
    isPending,
    onClose,
    onSubmit,
    ...
    state: SemanticMemoryPathDialogState | null;
}) {
...
export interface SemanticMemoryDeleteTarget {
    kind: 'folder' | 'page';
    path: string;
    title: string;
}

export function SemanticMemoryDeleteDialog({
    errorMessage,
    isPending,
    onClose,
    onDelete,
    ...
    target: SemanticMemoryDeleteTarget | null;
}) {
    return (
        <Dialog
            onOpenChange={(open) => {
