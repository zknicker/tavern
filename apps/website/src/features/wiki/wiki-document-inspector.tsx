...
import { useWikiBacklinks } from '../../hooks/wiki/use-wiki-backlinks.ts';
...
function PageSignals({ page }: { page: WikiPageDetail }) {
...
function BacklinksPanel({
    ...
    const backlinksQuery = useWikiBacklinks({ path: page.path });
