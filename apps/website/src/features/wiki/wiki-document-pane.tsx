...
import { WikiMarkdownEditor } from './wiki-markdown-editor.tsx';
import type { WikiLinkNavigate } from './wiki-markdown-viewer.tsx';
import type { WikiEditorMode } from './wiki-topbar.tsx';

export function WikiDocumentPane({
    draft,
    editorMode,
    externalChangeState,
    inspectorOpen,
                ...
                >
                    {inspectorOpen ? (
                        <div className="h-full w-[320px]">
                            <WikiDocumentInspector onSelectPage={onSelectPage} page={page} />
                        </div>
                    ) : null}
                </aside>
            </div>
