    ...
    const markup = renderToStaticMarkup(
        <ChatCardHeader
            ...
            chat={{
                ...
                displayName: 'general',
                externalId: 'discord:1090835947375054888#general',
                framework: 'discord',
                hasActivity: true,
                id: 'chat-1',
                isDisabled: false,
                ...
                target: 'channel:1090835947375054888',
    ...
    const markup = renderToStaticMarkup(
        <ChatCardHeader
            ...
            chat={{
                ...
                externalId: 'user:778786269458464829',
    ...
    const markup = renderToStaticMarkup(
        <ChatCardHeader
            ...
            chat={{
                ...
                externalId: '220f46ed-2d7c-41dd-9d7e-d02691f1afc3',
                framework: 'agentRuntime',
                hasActivity: false,
    ...
    const markup = renderToStaticMarkup(
        <ChatCardHeader
            ...
            chat={{
                ...
                externalId: 'internal:agent:main:main',
                framework: 'agentRuntime',
                hasActivity: true,
