...
import { type MarkdownBlock, parseMarkdownBlocks } from './vault-markdown-parser.ts';

export type VaultLinkNavigate = (target: string) => void;

export function VaultMarkdownViewer({
    onNavigate,
    value,
}: {
