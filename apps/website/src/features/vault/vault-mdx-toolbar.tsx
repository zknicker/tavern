...
export function VaultEditorToolbar() {
    ...
    return (
        <div className="vault-mdx-toolbar-shell">
            <div className="vault-mdx-toolbar-groups">
                <ToolbarGroup>
...
function ToolbarGroup({ children }: { children: React.ReactNode }) {
    return <div className="vault-mdx-toolbar-group">{children}</div>;
}
