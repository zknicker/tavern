...
function DiscordGlyph() {
    return (
        <svg aria-hidden="true" className="size-[0.95em]" fill="currentColor" viewBox="0 0 32 32">
...
export function DiscordBadge({ account, className, detail }: DiscordBadgeProps) {
    return (
        <span className={cn('inline-flex items-center gap-1', className)}>
            <Badge className="border-transparent bg-[#5865f2] text-white" variant="secondary">
                <DiscordGlyph />
                Discord
            </Badge>
            {account ? (
