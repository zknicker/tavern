...
export function buildOpenClawCronSchedule(config: CronScheduleConfig): OpenClawCronSchedule {
    switch (config.kind) {
        case 'interval':
            return {
...
function withTimezone<T extends OpenClawCronSchedule>(schedule: T, tz: string | undefined): T {
