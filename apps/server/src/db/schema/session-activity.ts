...
export const sessionMessagesTable = sqliteTable(
    'session_messages',
    {
        ...
        openClawApi: text('openclaw_api'),
        openClawHarness: text('openclaw_harness'),
        openClawModel: text('openclaw_model'),
        openClawModelNameId: text('openclaw_model_name_id'),
        openClawProvider: text('openclaw_provider'),
