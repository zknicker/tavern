...
import {
    ...
    legacyBootstrapFileNamesToClear,
...
describe('generated agent instructions', () => {
    ...
    test('tells the agent AGENTS.md is immutable and NOTES.md is its scratch space', () => {
        ...
        expect(content).toContain('`skills_list external search`');
    ...
    test('keeps critical operating guidance before large generated sections', () => {
        ...
        expect(content.indexOf('## Visible Progress')).toBeLessThan(agentContextHeadChars);
        expect(content.indexOf('## Inspectable Outputs')).toBeLessThan(agentContextHeadChars);
        expect(content.indexOf('## Notes And Skills')).toBeLessThan(agentContextHeadChars);
        expect(content.indexOf('## Memory')).toBeLessThan(agentContextHeadChars);
        expect(content.indexOf('## Vault')).toBeLessThan(agentContextHeadChars);
