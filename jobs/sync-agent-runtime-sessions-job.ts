...
import { syncAgentRuntimeSessions } from '../apps/server/src/sync/agent-runtime-sync.ts';
...
export const syncRuntimeSessionsJob = defineJob('sync-runtime-sessions')
    ...
    .description('Reads configured runtime connections and stores session records for Tavern.')
