...
import { syncAgentRuntimeCron } from '../apps/server/src/sync/agent-runtime-sync.ts';
...
export const syncRuntimeCronJob = defineJob('sync-runtime-cron')
    ...
    .description('Reads configured runtime connections and stores cron records for Tavern.')
