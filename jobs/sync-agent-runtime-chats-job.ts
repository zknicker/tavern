...
import { syncAgentRuntimeChats } from '../apps/server/src/sync/agent-runtime-projections.ts';
...
export const syncRuntimeChatsJob = defineJob('sync-runtime-chats')
    ...
    .description('Reads configured runtime connections and stores chat projections for Tavern.')
